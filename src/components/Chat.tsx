    ...
    return (
        <div className={classNames("wy-messenger-conversation wy-scroll-y", className)}>
            ...
            {selectedId && dataMembers && dataChat && dataConversation && dataFeatures &&
                <Messages id={selectedId} contextual={true} chatRoom={true} members={dataMembers} lastMessageId={dataConversation.last_message?.id} features={dataFeatures} appFeatures={features}/>
            }
        </div>
    )
}
